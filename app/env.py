...
DEFAULT_LITELLM_LOGGER_FN_MODULE_NAME = None
LITELLM_LOGGER_FN_MODULE_NAME = os.environ.get(
    "LITELLM_LOGGER_FN_MODULE_NAME", DEFAULT_LITELLM_LOGGER_FN_MODULE_NAME
)
